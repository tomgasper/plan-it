/* TAKEN FROM .NET CORE SOURCE CODE */
...
namespace PlanIt.WebApi.Errors;
...
/// </summary>
public class PlanItProblemDetailsFactory : ProblemDetailsFactory
{
    private readonly ApiBehaviorOptions _options;
    private readonly Action<ProblemDetailsContext>? _configure;

    public PlanItProblemDetailsFactory(
    ...
    private void ApplyProblemDetailsDefaults(HttpContext httpContext, ProblemDetails problemDetails, int statusCode)
    {
        ...
        problemDetails.Extensions["Some property"] = "Some value";
